...
void mainMenu::setShadersProperties(Shader simpleShader, Shader lightShader, Shader animShader) {
	...
	//view
	glm::mat4 view_animation = glm::mat4(UNIT);
...
void mainMenu::init() {
	...
	button_NewGame = new button(3.5f, UNIT, 2.58f, 0.3f, glm::radians(-85.1f), UNIT, 0.0f, 0.0f);
	button_NewGame->init("models/menu/button_play.dae");

	button_Left = new button(-2.5f, UNIT, -1.2f, 0.3f, glm::radians(-85.1f), UNIT, 0.0f, 0.0f);
	button_Left->init("models/menu/button_left.dae");

	button_Right = new button(2.5f, UNIT, -1.2f, 0.3f, glm::radians(-85.1f), UNIT, 0.0f, 0.0f);
	...
	animationTime_brycePosing = UNIT;
...
void mainMenu::draw(Shader simpleShader, Shader lightShader, Shader animShader) {
	...
	if (selected_weapon == WEAPON_SNIPER) {
		...
		glm::mat4 model_boun_sniper = glm::mat4(UNIT);
		model_boun_sniper = glm::translate(model_boun_sniper, glm::vec3(0.0f, UNIT, 3.0f));
		model_boun_sniper = glm::rotate(model_boun_sniper, glm::radians(-86.0f), glm::vec3(UNIT, 0.0f, 0.0f));
		...
		glm::mat4 model_boun_shotgun = glm::mat4(UNIT);
		model_boun_shotgun = glm::translate(model_boun_shotgun, glm::vec3(-4.0f, UNIT, 3.0f));
		model_boun_shotgun = glm::rotate(model_boun_shotgun, glm::radians(-85.25f), glm::vec3(UNIT, 0.0f, 0.0f));
		model_boun_shotgun = glm::scale(model_boun_shotgun, glm::vec3(0.38f, 0.38f, 0.38f));
		simpleShader.setMat4("model", model_boun_shotgun);

		simpleShader.setVec4("colorcube", UNIT, 0.0f, 0.0f,0.0f);	
	...
	glm::mat4 model_shotgun = glm::mat4(UNIT);
	model_shotgun = glm::translate(model_shotgun, glm::vec3(-4.0f, UNIT, 3.0f));
	model_shotgun = glm::rotate(model_shotgun, glm::radians(0.0f), glm::vec3(0.0f, UNIT, 0.0f));
	...
	glm::mat4 model_sniper = glm::mat4(UNIT);
	model_sniper = glm::translate(model_sniper, glm::vec3(0.0f, UNIT, 3.0f));
	model_sniper = glm::rotate(model_sniper, glm::radians(0.0f), glm::vec3(0.0f, UNIT, 0.0f));
	...
	model = glm::translate(model, glm::vec3(0.0f, UNIT, 0.0f));
	model = glm::rotate(model, 0.0f, glm::vec3(0.0f, UNIT, 0.0f));
	model = glm::rotate(model, glm::radians(-70.0f), glm::vec3(UNIT, 0.0f, 0.0f)); //per metterlo in posizione verticale sul pavimento
